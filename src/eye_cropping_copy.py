...
path = r'C:\Users\danie\Pictures\Retna' # Folder of the captured data
path2 = r'C:\Users\danie\Pictures\RetnaFaces' # Output folder - faces 
path3 = r'C:\Users\danie\Pictures\RetnaEyes' # Output folder - eyes
